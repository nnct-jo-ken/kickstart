...
さて，お気づきの方もいるかもしれませんがこの```size(数字,数字);```というのは画面のサイズを指定しています．厳密には，```size(x,y);```というコードは画面の横の長さをx，縦の長さをyにする，という意味を持っています．
...
#### 演習2-3
>[ 演習2-2 ]( #演習2-2 )のコードに書き足して，演習2-2で描いた正方形の内側にぴったり接する円を描け．
